...
export default function HomePage() {
  ...
  return (
    <div className="flex   items-center justify-around max-[1100px]:justify-center max-[700px]:justify-start h-[80%] max-[1200px]:h-[100%] max-[1200px]:flex-col max-[1200px]:my-[6rem] max-[700px]:my-[20rem] max-[1200px]:gap-[15rem]">
      ...
      <div
        className="w-[45%]  max-[1200px]:w-[90%] max-[1200px]:h-[40%] h-[80%] dark:shadow-2xl bg-cover   rounded-[2.5rem] bg-[url('/assets/property_types_image.webp')] bg-center flex items-end justify-center hover:cursor-pointer shadow-lg"
